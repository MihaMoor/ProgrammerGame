...
{
    /// <summary>
    /// Converts a <see cref="PlayerEntity"/> to a <see cref="Domain.Player"/>.
    /// </summary>
    /// <returns>The corresponding <see cref="Domain.Player"/> instance.</returns>
    /// <exception cref="Exception">
    /// Thrown if the domain player cannot be created from the entity's properties.
    /// </exception>
    ...
    /// <summary>
            /// Converts a domain player instance to a corresponding <see cref="PlayerEntity"/> for persistence.
            /// </summary>
