...
internal static class PlayerExtensions
{
    /// <summary>
        ...
        /// <returns>A <see cref="PlayerDto"/> representing the player's data, including pocket money as a <see cref="Google.Type.Money"/>.</returns>
...
public static class MoneyConverter
{
    ...
    /// <summary>
    /// Converts a decimal monetary amount to a <see cref="Google.Type.Money"/> object, splitting the value into units and nanos and handling negative amounts correctly.
    /// </summary>
    /// <param name="amount">The monetary amount to convert.</param>
    /// <param name="currencyCode">The ISO currency code to use. Defaults to "RUB".</param>
    ...
    /// <returns>The decimal representation of the monetary amount, preserving the correct sign.</returns>
