...
{
    /// <summary>
    /// Initializes a new instance of the <see cref="Result"/> class, enforcing consistency between success state and error.
    /// </summary>
    /// <param name="isSuccess">Indicates whether the result represents a success.</param>
    /// <param name="error">The associated error if the result is a failure, or <see cref="Error.None"/> if successful.</param>
