...
public class Result
{
    ...
    /// <param name="error">The error associated with the result. Must be <see cref="Error.None"/> if successful, or a specific error if failed.</param>
...
public class Result<TValue> : Result
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="Result{TValue}"/> class with the specified value, success state, and error information.
    /// </summary>
    ...
    /// <param name="error">The error information for a failure result, or <see cref="Error.None"/> for success.</param>
