...
public static class EndpointExtensions
{
    ...
    /// <summary>
    /// Registers all non-abstract types implementing <see cref="IEndpoint"/> from the specified assembly as transient services.
    /// </summary>
    ...
    /// Optional. The <see cref="RouteGroupBuilder"/> to use for mapping endpoints. If null, the <see cref="WebApplication"/> is used.
    /// </param>
